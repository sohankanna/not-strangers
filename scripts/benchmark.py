"""Task 5 (latency and scale benchmark): thin standalone wrapper.

The actual logic now lives in src/run_pipeline.py (write_benchmark) so
...
def main() -> None:
    ...
    run_pipeline.write_benchmark(pipeline_data, trained)
