"""Task 3 (audit trail): thin standalone wrapper.

The actual logic now lives in src/run_pipeline.py (write_audit_sample) so
...
def main() -> None:
    ...
    run_pipeline.write_audit_sample(pipeline_data, trained)
    print("Wrote results/audit_sample.jsonl")
